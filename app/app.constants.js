...
export const idInputFutBinPrice = "elem_" + generateId(15);
export const idSellSamePlayerFutBinPrice = "elem_" + generateId(15);
...
export const idPackDuplicatesPlayersAction = "elem_" + generateId(15);
export const idPackDuplicatesNonPlayersAction = "elem_" + generateId(15);
